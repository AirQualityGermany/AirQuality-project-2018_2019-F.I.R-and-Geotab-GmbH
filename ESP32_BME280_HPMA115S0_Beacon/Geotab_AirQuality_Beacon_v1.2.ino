/***************************************************************************
  Geotab Airquality BLE Beacon - ESP32 edition v1.2
  Measured values: Temperature, Humidity, PM 2.5, PM 10, NO2
...
void setup() {
  ...
  // Reading temperature
  //int tempval = round(10*bme.readTemperature());
  //float tempfval = (float)tempval/10;
  ...
  // TX Power Level
  manfdata[3]= 0xC6;
  // Battery level - Used as SW version number: 1.2
  //manfdata[4]= 0x64;
  manfdata[4] = 0x12;
  // Temperature
  manfdata[5]= 0x07;
  ...
  manfdata[14]= 0x00;
  manfdata[15]= pm2_5array[2];
  manfdata[16]= pm2_5array[3];
  // PM 10
  manfdata[17]= 0x0E;
